 ...
 * 
 * @description
 * 공지사항 목록 및 상세 내용을 전체 페이지 형태로 표시하는 컴포넌트
 * - 유스케이스: 10.4 공지사항 조회
 * 
 * @features
 * 1. 공지사항 목록 조회:
 *    - 고정(Pinned) 공지사항 배지 표시
 *    - 카드 형태의 목록 UI
 * 2. 공지사항 상세 조회:
 *    - Markdown 및 GFM(GitHub Flavored Markdown) 렌더링 지원
 *    - 상세 보기 시 뒤로가기 네비게이션
 * 3. 애니메이션:
 *    - 목록/상세 진입 시 슬라이드 애니메이션 적용
 * 
 * @props
 * - onBack: 뒤로가기 버튼 클릭 시 호출되는 핸들러
 * 
 * ====================================================================================================
 */
