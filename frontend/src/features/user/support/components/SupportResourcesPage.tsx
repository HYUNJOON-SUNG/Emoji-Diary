 ...
 * 
 * @description
 * 정신건강 지원 기관 목록을 제공하고 위험 수준에 따른 안내를 표시하는 컴포넌트
 * - 유스케이스: 12.1 상담 기관 조회
 * - 모바일 웹 최적화됨
 * 
 * @features
 * 1. 기관 목록 조회 및 필터링:
 *    - 전체/긴급/전문/전화/의료 등 카테고리별 필터링
 * 2. 위험 신호 경고 표시:
 *    - 사용자의 위험 분석 결과(riskLevel)가 있을 경우 상단에 경고 메시지 표시
 * 3. 긴급 상담 안내:
 *    - '도움말' 버튼을 통해 자살 예방 핫라인 등 긴급 연락처 안내 모달 표시
 * 4. 빠른 연결:
 *    - 전화번호 클릭 시 바로 전화 걸기 연결
 *    - 웹사이트 링크 연결
 * 
 * @props
 * - showRiskWarning: 위험 경고 표시 여부 (분석 리포트에서 진입 시 true)
 * - riskLevel: 위험 수준 (low, medium, high)
 * - riskReasons: 위험 판단 근거 목록
 * - onBack: 뒤로가기 핸들러
 * 
 * ====================================================================================================
 */
