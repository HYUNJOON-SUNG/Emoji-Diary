 ...
 * 
 * @description
 * 앱 최초 진입 시 사용자에게 보여지는 랜딩 페이지
 * - 사용자의 감정을 기록하는 다이어리 컨셉을 시각적으로 전달
 * - "일기장 열기" 액션을 통해 메인 기능으로 진입 유도
 * 
 * @features
 * 1. 시각적 몰입감:
 *    - 전체 화면 모바일 웹 디자인
 *    - Glassmorphism (유리 질감) UI 적용
 *    - 톤온톤 그라데이션 및 그림자 효과
 * 2. 진입점 역할:
 *    - UserApp의 초기 화면으로 동작
 * 
 * @flow [플로우 1.1] 앱 진입
 * - 사용자 접속 -> LandingPage 표시 -> "일기장 열기" 클릭 -> 로그인/메인으로 전환 (onOpenBook)
 * 
 * @props
 * - onOpenBook: 일기장 열기(앱 시작) 버튼 클릭 핸들러
 * 
 * ====================================================================================================
 */
